...
class TIbot:
    ...
    def __init__(self, username: str, password: str, sleep: int, tiktok_usernames: list) -> None:
        ...
        self.video_ids = []
        self.cl = Client()
        if self.cl.login(self.username, self.password): print("Login successful")
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            for tiktokusername in self.tiktok_usernames:
                video_url, video_id = self.get_last_video_id_form_tiktok(tiktokusername)
                if video_id in self.video_ids:
                    ...
                    if duration > 60:
                        ...
                        try:
                            ...
                            print("{} uploaded {}".format(tiktokusername, video_id))
